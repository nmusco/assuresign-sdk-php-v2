...
/**
 * This class stands for UpdateUserResult StructType
 * @subpackage Structs
 */
class UpdateUserResult extends AbstractStructBase
{
    /**
     * The Success
    ...
    public $Exceptions;
    /**
     * Constructor method for UpdateUserResult
     * @uses UpdateUserResult::setSuccess()
     * @uses UpdateUserResult::setExceptions()
     * @param bool $success
     ...
     * Set Success value
     * @param bool $success
     * @return \Nmusco\AssureSign\v2\StructType\UpdateUserResult
     */
