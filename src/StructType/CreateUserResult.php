...
/**
 * This class stands for CreateUserResult StructType
 * @subpackage Structs
 */
class CreateUserResult extends AbstractStructBase
{
    /**
     * The Success
    ...
    public $Exceptions;
    /**
     * Constructor method for CreateUserResult
     * @uses CreateUserResult::setSuccess()
     * @uses CreateUserResult::setExceptions()
     * @param bool $success
     ...
     * Set Success value
     * @param bool $success
     * @return \Nmusco\AssureSign\v2\StructType\CreateUserResult
     */
